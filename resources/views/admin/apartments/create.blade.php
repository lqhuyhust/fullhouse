...
@section('title','Create a new Apartment')
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Apartment Add</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.apartments.create.store')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="photo-preview mt-3">
                                <img id="preview-image-before-upload" src=""
                                    alt="preview image" style="max-height: 500px;display:none;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
