...
const updateApartment = () => {
    ...
    axios.post(`/api/apartments/edit/${props.id}`, formData)
        .then((response) => {
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputDeposit" name="deposit" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-success float-right" @click="updateApartment()">Update
                                        Apartment</button>
                                </div>
                            </div>
                        </div>
